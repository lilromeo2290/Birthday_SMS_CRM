      ...
      <div className="lg:pl-64 min-h-screen flex flex-col">
        ...
        <footer className="border-t border-slate-800 py-4 px-4 md:px-6 mt-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <a href="https://clipe233eng.net/" target="_blank" rel="noopener noreferrer" className="text-xs text-slate-600 hover:text-emerald-400 transition-colors">Powered by Clipe233 Engineers</a>
          </div>
        </footer>
      </div>
    </div>
